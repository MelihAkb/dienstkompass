...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    url("/tvoed/vka/2026/rechner", 0.8, "monthly"),
    url("/tvoed/vka/2025", 0.9, "monthly"),
    url("/tvoed/vka/2025/rechner", 0.9, "monthly"),
    url("/tvoed/vka/2024", 0.7, "monthly"),
    url("/tvoed/vka/2024/rechner", 0.7, "monthly"),
    ...
    url("/tvoed/bund/2026/rechner", 0.8, "monthly"),
    url("/tvoed/bund/2025", 0.9, "monthly"),
    url("/tvoed/bund/2025/rechner", 0.9, "monthly"),
    url("/tvoed/bund/2024", 0.7, "monthly"),
    url("/tvoed/bund/2024/rechner", 0.7, "monthly"),
    ...
    url("/beamte/bund/2025", 0.8, "monthly"),
    url("/beamte/bund/2024", 0.7, "monthly"),
    url("/beamte/bund/tarifrunden/2024", 0.8, "monthly"),
    url("/beamte/bund/tarifrunden/2022", 0.7, "monthly"),
    url("/beamte/bw", 0.8, "monthly"),
    url("/beamte/bw/2025", 0.7, "monthly"),
    url("/beamte/bw/2024", 0.7, "monthly"),
    url("/beamte/bw/2023", 0.6, "monthly"),
    url("/beamte/bw/2022", 0.6, "monthly"),
    url("/beamte/bw/2021", 0.6, "monthly"),
